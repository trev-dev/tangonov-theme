...
;; [[file:tangonov-theme.org::+BEGIN_SRC elisp
;; (require 'cl-lib)
;; #+END_SRC
...
;;  `(isearch-fail ((,spec (:background][Dependences:1]]
(require 'cl-lib)
...
;; #+BEGIN_SRC elisp
;;  `(isearch ((,spec (:inherit match :weight bold))))
;;  `(isearch-fail ((,spec (:background][Converting named colors to hexidecimal colors:1]]
(defun name-to-rgb (color)
  "Get the hexidecimal version of the named `COLOR'."
  (cl-loop with div = (float (car (tty-color-standard-values "#ffffff")))
           for x in (tty-color-standard-values (downcase color))
...
;; #+BEGIN_SRC elisp
;;  `(isearch ((,spec (:inherit match :weight bold))))
;;  `(isearch-fail ((,spec (:background][Blending colors:1]]
(defun color-blend (c1 c2 alpha)
  "Blend hexidecimal colors `C1' and `C2' together by a coefficient of `ALPHA'."
  (when (and c1 c2)
    (cond ((or (listp c1) (listp c2))
...
;; #+BEGIN_SRC elisp
;;  `(isearch ((,spec (:inherit match :weight bold))))
;;  `(isearch-fail ((,spec (:background][Blending colors:2]]
(defun color-darken (color alpha)
  "Darken a hexidecimal `COLOR' by a coefficient of `ALPHA'.
Alpha should be a float between 0 and 1."
  (cond ((listp color)
...
;; #+BEGIN_SRC elisp
;;  `(isearch ((,spec (:inherit match :weight bold))))
;;  `(isearch-fail ((,spec (:background][Color Definitions:1]]
(deftheme tangonov
  "A 256 color dark theme featuring bright pastels.")
...
;; #+BEGIN_SRC elisp
;;  `(isearch ((,spec (:inherit match :weight bold))))
;;  `(isearch-fail ((,spec (:background][Basic Faces:1]]
   `(default ((,spec (:background ,bg :foreground ,fg))))
   `(bold ((,spec (:weight bold))))
   `(italic ((,spec (:slant italic))))
   `(bold-italic ((,spec (:weight bold :slant italic))))
...
;; #+BEGIN_SRC elisp
;;  `(isearch ((,spec (:inherit match :weight bold))))
;;  `(isearch-fail ((,spec (:background][Font Lock Faces:1]]
   ;; Font Lock
   `(font-lock-warning-face ((,spec (:inherit warning))))
   `(font-lock-function-name-face ((,spec (:foreground ,blue))))
   `(font-lock-variable-name-face ((,spec (:foreground ,yellow))))
...
;; [[file:tangonov-theme.org::+BEGIN_SRC elisp
;;  `(isearch ((,spec (:inherit match :weight bold))))
;;  `(isearch-fail ((,spec (:background][ISearch:1]]
   `(isearch ((,spec (:inherit match :weight bold))))
   `(isearch-fail ((,spec (:background ,red :foreground ,gray1 :weight bold))))
;; ISearch:1 ends here

;; [[file:tangonov-theme.org::,red :foreground ,gray1 :weight bold))))
;; #+END_SRC

;; ** Easy Customization][Easy Customization:1]]
   `(custom-button
     ((,spec
...
;; Set faces for the top and bottom "bars."][Modeline & Tabbar:1]]
   ;; Modeline/Tabline
   `(mode-line
...
;; Magit is a monster sized package with many, many faces][Magit:1]]
...
;; ** Rainbow Delimiters][Rainbow Delimiters:1]]
...
;; ** List End & Provide Theme][List End & Provide Theme:1]]
  ))
